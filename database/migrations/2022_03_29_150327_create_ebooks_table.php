...
class CreateEbooksTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('ebooks', function (Blueprint $table) {
            ...
            $table->string('keywords')->nullable(); //search word
            $table->string('title')->nullable();
            $table->string('slug')->nullable();

            $table->string('type')->nullable(); //Article, manual, url, upload, dfy etc
            ...
            $table->string('append_desc_pdf')->nullable(); //file used in uploadcontroller
            $table->string('url_append_desc_pdf')->nullable();
            $table->string('prepend_summ_pdf')->nullable(); //file used in uploadcontroller
            $table->string('url_prepend_summ_pdf')->nullable();
            $table->string('original_pdf_upload')->nullable();
            $table->string('url_original_pdf_upload')->nullable();
            $table->string('merged_pdf_upload')->nullable(); //after merging
