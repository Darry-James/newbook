...
class CreateProductNoSaleSampleTemplatesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('product_no_sale_sample_templates', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('product_no_sale_sample_templates');
    }
}
