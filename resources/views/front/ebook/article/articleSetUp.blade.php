    ...
    <div class="content-section">
        <div class="container-fluid custom-x-padding">
            <div class="bg-light create-manual-box pb-3">
                ...
                <form action="{{ route('articleSetUpPost') }}" method="POST" id="setupForm">@csrf
                    ...
                    <div class="x-pd-r mb-3">
                        <div class="table-gen-chapter-wrap">
                            <div class="table-head">
                                ...
                                <a target="_blank" href="{{ route('pgManager', ['article']) }}" class="btn btn-gen-chapter">Add New Chapter</a>
                                </div>
                            </div>
                                            ...
                                            <td class="text-center">
                                                <nav class="nav justify-content-center table-actions">
                                                    ...
                                                    <li class="nav-item d-none">
                                                        <a class="nav-link px-1" target="_blank" href="{{ url('/builder/6037a28418c95/default/'.$chapter->id) }}" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit">
                                        ...
                                        <div class="row">
                                            ...
                                            @foreach ($ecoverList as $ecover)
                                                <div class="col-md-3 mb-1 mt-2">
                                                    <a href="javascript:void(0);" id="{{ $ecover->id }}" data-source="{{ $ecover->thumbnail ? asset('/backend/assets/images/big/'.$ecover->thumbnail) : asset('/backend/assets/images/big/placeholder.png') }}" alt="{{ env('APP_NAME') }}" class="selected_file">

                                                        <img class="rounded" src="{{ $ecover->thumbnail ? asset('/backend/assets/images/big/'.$ecover->thumbnail) : asset('/backend/assets/images/big/placeholder.png') }}" alt="{{ env('APP_NAME') }}" />
