    ...
    <div class="content-section">
        <div class="container-fluid custom-x-padding">
            <div class="bg-light create-manual-box pb-3">
                ...
                <!--form-start--->
                <form action="{{ route('manualSetUpPost') }}" method="POST" id="setupForm">@csrf

                    <!--title-start-->
                    <div class="row x-pd-r">
                        <div class="col-3">
                            <div class="form-group">
                                <label for="ebook_title">TITLEs</label>
                                <input id="ebook_title" class="form-control no-shadow input-signin" type="text" name="title" value="{{ ucFirst($keywords) }}" required>
                            </div>
                        </div>
                        ...
                        <div class="col-3">
                            <div class="form-group">
                                ...
                                <input id="author_name" class="form-control no-shadow input-signin" type="text" name="ebook_author" autocomplete="on" value="{{ Auth::user()->name }}" required>
                            </div>
                        </div>
                        <div class="col-3">
                            <div class="form-group">
                    ...
                    <div class="row x-pd-r">
                        ...
                        <div class="col-4">
                            <div class="form-group">
                                <label for="body_font_family">BODY FONT FAMILY</label>
                                <select id="body_font_family" class="form-control no-shadow input-signin" name="body_font_family">
                        ...
                        <div class="col-4">
                            <div class="form-group">
                                ...
                                <select id="font_size" name="body_font_size" class="form-control no-shadow input-signin">
                    ...
                    <div class="row x-pd-r">
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input id="header_text" class="form-control no-shadow input-signin" type="text"  name="header_text">
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                    ...
                    <div class="row x-pd-r">
                        <div class="col-3">
                            <div class="form-group">
                                <label for="header_text_align">ALIGN</label>
                        ...
                        <div class="col-3">
                            <div class="form-group">
                                <label for="header_text_color">Color</label>
                    ...
                    <div class="row x-pd-r">
                        <div class="col-3">
                            <div class="form-group">
                                <label for="footer_text_align">ALIGN</label>
                        ...
                        <div class="col-3">
                            <div class="form-group">
                                <label for="footer_text_color">Color</label>
                    ...
                    <div class="row x-pd-r">
                        <div class="col-3">
                            <div class="form-group">
                                <label for="title_text_align">ALIGN</label>
                                <select id="title_text_align" class="form-control no-shadow input-signin" name="title_text_align">
                                    <option value="left">Left</option>
                                    <option value="center">Center</option>
                                    <option value="right">Right</option>
                                </select>
                        ...
                        <div class="col-3">
                            <div class="form-group">
                                <label for="title_text_color">Color</label>
                                <input id="title_text_color" class="form-control no-shadow input-signin" type="color" name="title_text_color">
                            </div>
                        </div>
                        <div class="col-3">
                            <div class="form-group">
                                <label for="title_font_size">TEXT SIZE</label>
                                <select id="title_font_size" name="title_font_size" class="form-control no-shadow input-signin">
                                    <option value="8">8px</option>
                                    <option value="9">9px</option>
                                    <option value="10">10px</option>
                                    <option value="11">11px</option>
                    ...
                    <div class="row x-pd-r">
                        <div class="col-3">
                            <div class="form-group">
                                <label for="subheader_text_align">ALIGN</label>
                        ...
                        <div class="col-3">
                            <div class="form-group">
                                <label for="subheader_font_family">FONT FAMILY</label>
                    ...
                    <div class="x-pd-r mb-3">
                        <div class="table-gen-chapter-wrap">
                            <div class="table-head">
                                ...
                                <a target="_blank" href="{{ route('pgManager', ['manual']) }}" class="btn btn-gen-chapter">Add New Chapter</a>
                                </div>
                            </div>
                                ...
                                <tbody>
                                    @if (count($selectedChapters) > 0)
                                        ...
                                        <tr>
                                            ...
                                            <td style="font-size: 0.8rem;">{!! $chapter->title !!}</td>
                                            <td class="text-left">
                                                <nav class="nav justify-content-left table-actions">                    
                                                    {{-- <li class="nav-item d-none">
                                                        <a class="nav-link px-1" target="_blank" href="{{ route('PageBuilderChapter', ['6037a28418c95', 'default', 'manual', $chapter->id]) }}" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit">
                                                            <img src="../assets/icons/copy to my funnel.svg" alt="">
                                                        </a>
                                                    </li> --}}

                                                    <li class="nav-item">
                                                        <a class="nav-link px-1" target="_blank" href="{{ route('pgManager', [$chapter->chapter_type, $chapter->id]) }}" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit">
                                                            <img src="../assets/icons/copy to my funnel.svg" alt="">
                                                        </a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link px-1" href="{{ route('deleteArticleSelect', $chapter->id) }}" data-toggle="tooltip" data-placement="top" title="" onclick="return confirm('Are you sure you wish to delete this Chapter?');" data-original-title="Delete">
                                            ...
                                            <td class="text-left">
                                                ...
                                                <input type="hidden" name="chapter_description[]" value="{{ $chapter->description }}">
                                            </td>
                                        </tr>
                                            @php $counter++ @endphp   
                                        @endforeach
                    ...
                    <div class="x-pd-r mt-5">
                        <div class="table-gen-chapter-wrap">
                            <div class="table-head">
                                ...
                                <div class="left-section ml-auto">
                                    {{-- <a class="btn btn-gen-chapter" id="copyDfyChaptersBtn"> Copy To eBook</a> --}}
                                    <button type="submit" class="btn btn-gen-chapter" id="copyDfyChaptersBtn" disabled>Copy To eBook</button>
                                    <input type="hidden" class="copiedDfyChaptersArticle" name="copiedDfyChaptersArticle" id="copiedDfyChaptersArticle" value="">
                                    <input type="hidden" class="copiedDfyChaptersDescription" name="copiedDfyChaptersDescription" id="copiedDfyChaptersDescription" value="">
                                </div>
                            </div>
                            <table class="table table-striped table-bordered table-hover">
                                <tbody>
                                    @if (count($selectedChapters) > 0)
                                        @foreach ($selectedChapters as $each_dfy_chapters)
                                        <tr class="selected_dfyChapter">
                                            <td>{{ $each_dfy_chapters->article_title }}
                                                <input type="hidden" class="article_title" name="article_title[]" value="{{ $each_dfy_chapters->article_title }}">
                                                <input type="hidden" class="article_description" name="article_description[]" value="{{ $each_dfy_chapters->article_description }}">
                                            </td> 
                                        </tr> 
                                        @endforeach
                                    @else
                                        ...
                                        <div class="row">
                                            ...
                                            @foreach ($ecoverList as $each_ecover)
                                                <div class="col-md-3 mb-1 mt-2">
                                                    <a href="javascript:void(0);" id="{{ $each_ecover->id }}" data-source="{{ $each_ecover->thumbnail }}" class="selected_file">
...
@section('extra_js')  
  ...
  <script>
      ...
      console.log(location.protocol + '//' + location.host + '/'); //127.0.0.1:8000
    ...
    //         key: 'C7vK2sYsnBjWACO5HfhkUBM0TMFG/lpLmygKNmr4C7Og3bsDpECFRL3Wf4RNZYFciQkdCsUsafww20uhILXTGw=='
    //     },
    // });
</script>
