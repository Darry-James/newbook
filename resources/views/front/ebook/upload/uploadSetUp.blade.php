                ...
                <form action="{{ route('uploadSetUpPost') }}" method="POST" id="setupForm" enctype="multipart/form-data">@csrf
                    ...
                    <div class="editor-main x-pd-r">
                        ...
                        <div class="editor-wrap mb-4">
                            ...
                            <textarea class="tinymce w-100" name="description" id="" cols="30" rows="10">{{ \Session::get('description') ? \Session::get('description') : '' }}</textarea>
                    ...
                    <div class="editor-main x-pd-r">
                        ...
                        <div class="editor-wrap mb-4">
                            ...
                            <textarea class="tinymce w-100" name="summary" id="" cols="30" rows="10">{{ \Session::get('summary') ? \Session::get('summary') : '' }}</textarea>
