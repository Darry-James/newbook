        ...
        <div class="container-fluid custom-x-padding">
            <div class="bg-light create-manual-box pb-3">
                <div class="d-flex align-item-center mb-5">
                    <h5 class="title">Create From URL</h5>
                ...
                <!--form-start--->
                <form action="{{ route('urlSetUpPost') }}" method="POST" id="setupForm">@csrf
                    ...
                    <div class="row x-pd-r">
                        <div class="col-3">
                            <div class="form-group">
                                ...
                                <input id="ebook_title" class="form-control no-shadow input-signin" type="text" name="title" value="topic" required>
                            </div>
                        </div>
                        ...
                        <div class="table-gen-chapter-wrap">
                            <div class="table-head">
                                ...
                                <div class="left-section ml-auto">
                                    <a target="_blank" href="{{ route('pgManager', ['url']) }}" class="btn btn-gen-chapter">Add New Chapter</a>
                                </div>
                            </div>
                            <table class="table table-striped table-bordered table-hover" id="myTable">
                                ...
                                <tbody id="selectedArts" class="selectedArts">
                                    ...
                                    @else
                                    <tr><td colspan="4" class="text-center">No Selected Chapters</td></tr>
                                    @endif
                ...
                <!-- tab panes -->
							<div class="tab-content">
								...
								<div class="tab-pane fade" id="library">
									...
									<a href="#" data-image-id="{{ $each_ecover->id }}">
