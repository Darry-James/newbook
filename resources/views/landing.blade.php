        ...
        <div class="row mt-5">
            <div class="col-3">
                <div class="dashboard-box first">
                    ...
                    <div class="value-wrap">
                        <div class="value">{{ $ebooks->count() }}</div>
            ...
            <div class="col-3">
                <div class="dashboard-box third">
                    ...
                    <div class="value-wrap">
                        <div class="value">{{ $funnels->count() }}</div>
            ...
            <div class="col-3">
                <div class="dashboard-box fifth">
                    ...
                    <div class="value-wrap">
                        <div class="value">{{ $flat_builders->count() }}</div>
            ...
            <div class="col-3">
                <div class="dashboard-box seventh">
                    ...
                    <div class="value-wrap">
                        <div class="value">{{ myTemplatesCount($products) }}</div>
            ...
            <div class="col-3">
                <div class="dashboard-box eighth">
                    ...
                    <div class="value-wrap">
                        <div class="value">{{ $images->count() }}</div>
