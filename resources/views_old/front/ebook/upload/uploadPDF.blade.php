    ...
    <body style="font-size: {{ $body_font_size != '' ? $body_font_size : '12px;' }}; font-family: {{ $body_font_family != '' ? $body_font_family : 'Junge'}};">
      ...
      <htmlpageheader name="page-header">
          ...
          {{-- <div style="left:0; right: 0; top: 0; bottom: 0;">
            ...
            <img src="https://res.cloudinary.com/funnel/image/upload/c_scale,h_3000/v1636124095/sample.jpg" alt="" style="width: 210mm; height: 297mm; margin: 0;" />
            <pagebreak>

      </div> --}}

      {{-- <div style="background-image: url('https://res.cloudinary.com/funnel/image/upload/v1636124095/sample.jpg');
            ...
            {{-- style="background-image: url('{{ asset('/front/image/ecover/' . $property->property_image) }}')" --}}
            <div id="cover" style="background-image: url('./front/image/ecover/{{$cover_image_local}}'); background-image-resize: 6; left:0; right: 0; top: 0; bottom: 0; width: 210mm; height: 297mm;">
                {{-- <pagebreak> --}}
            </div>
