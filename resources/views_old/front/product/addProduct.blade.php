...
<div class="content-section">
    ...
    <div class="container-fluid custom-padding">
        ...
        <form id="ProductForm" action="{{route('addProductPost')}}" method="post">@csrf
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div>
                                        ...
                                        @if ($errors->has('ebook_id')) <p class="help-block" style="color:red; position: relative; top:0px;">{{ $errors->first('ebook_id') }}</p> @endif
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div>
                ...
                <div class="tab-content">
                    <div class="tab-pane container fade" role="tabpanel" id="sales-page">
                        <div class="editor-wrap mb-4">
                            ...
                            <textarea class="tinymce w-100" name="sales_page_content" id="myeditorinstance1" data-edit="myeditor1" cols="30" rows="10"></textarea>
                        </div>
                    </div>
                    <div class="tab-pane container active" role="tabpanel" id="squeeze-page">
                        <div class="editor-wrap mb-4">
                            <!-- <div id="editor-squeeze"></div> -->
                            <textarea class="tinymce w-100" name="squeeze_thankyou_page" id="myeditorinstance2" data-edit="myeditor2" cols="30" rows="10"></textarea>
                        </div>
                    </div>
                    <div class="tab-pane container fade" role="tabpanel" id="download-page">
                        <div class="editor-wrap mb-4">
                            <!-- <div id="editor-download"></div> -->
                            <textarea class="tinymce w-100" name="download_content_page" id="myeditorinstance3" data-edit="myeditor3" cols="30" rows="10"></textarea>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane container active" role="tabpanel" id="exit-sales">
                            <div class="editor-wrap mb-4">
                                ...
                                <textarea class="tinymce w-100" name="exit_popup_sales_page_content" id="myeditorinstance4" data-edit="myeditor4" cols="30" rows="10"></textarea>
                            </div>
                        </div>
                        <div class="tab-pane container fade" role="tabpanel" id="exit-download">
                            <div class="editor-wrap mb-4">
                                <!-- <div id="exit-download-editor"></div> -->
                                <textarea class="tinymce w-100" name="exit_popup_download_page" id="myeditorinstance5" data-edit="myeditor5" cols="30" rows="10"></textarea>
                            </div>
                        </div>
                    </div>
...
function loadTemplates(){
    ...
    //alert(host);
    var templates = [];
    $.getJSON('http://127.0.0.1:9100/templates',function(response){
...
function loadSaleTemplates(){
    var templates = [];
    $.getJSON('http://127.0.0.1:9100/saleTemplates',function(response){
        //console.log(response);
        templates = response;
        $.each(templates, function(i, field){
...
function loadInEditor(id){
    ...
    $.getJSON('http://127.0.0.1:9100/getContent/'+id,function(res){
        //hide loading
...
function loadInSaleAndExitEditor(id){
    //alert('Loading template...');
    $('.loading').css({'display':'block'});
    $.getJSON('http://127.0.0.1:9100/getSaleContent/'+id,function(res){
        //hide loading
