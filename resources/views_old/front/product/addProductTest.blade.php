...
function loadTemplates(){
    ...
    //alert(host);
    var templates = [];
    $.getJSON('http://127.0.0.1:9000/templates',function(response){
...
function loadSaleTemplates(){
    var templates = [];
    $.getJSON('http://127.0.0.1:9000/saleTemplates',function(response){
        //console.log(response);
        templates = response;
        $.each(templates, function(i, field){
...
function loadInEditor(id){
    ...
    $.getJSON('http://127.0.0.1:9000/getContent/'+id,function(res){
        //hide loading
...
function loadInSaleAndExitEditor(id){
    //alert('Loading template...');
    $('.loading').css({'display':'block'});
    $.getJSON('http://127.0.0.1:9000/getSaleContent/'+id,function(res){
        //hide loading
